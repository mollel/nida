               ...
               <div class="span12">
                  <div class="portlet box blue" id="form_wizard_1">
                     <div class="portlet-title">
                        <h4>
                           <i class="icon-reorder"></i> personal details - <span class="step-title">Step 1 of 4</span>
                        </h4>
                     ...
                     <div class="portlet-body form">
                        <form action="<?php echo base_url();?>registration/store_natives_details" class="form-horizontal" method="post">
                           <div class="form-wizard">
                              ...
                              <div class="tab-content">
                                 <div class="tab-pane active" id="tab1">
                                    <h3 class="block">Provide your ID information</h3>
                                    <div class="control-group">
                                       <label class="control-label">passport ID</label>
                                       <div class="controls">
                                          <input type="text" class="span6 m-wrap" placeholder="passport" name="passportid"/>
                                       </div>
                                    </div>
                                     <div class="control-group">
                                       <label class="control-label">Driving ID</label>
                                       <div class="controls">
                                          <input type="text" class="span6 m-wrap" placeholder="Driving licence " name="drivingid"/>
                                       </div>
                                    </div>
                                     <div class="control-group">
                                       <label class="control-label">Vote ID</label>
                                       <div class="controls">
                                          <input type="text" class="span6 m-wrap" placeholder="namba ya kitambulisho" name="voteid"/>
                                       </div>
                                    </div>
                                     <div class="control-group">
                                       <label class="control-label">NHIF ID</label>
                                       <div class="controls">
                                          <input type="text" class="span6 m-wrap" placeholder="Bima ya afya" name="nhifid"/>
                                       </div>
                                    </div>
                                 </div>
